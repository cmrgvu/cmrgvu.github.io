...
<br>
<ul>
<li>Choice architects need to understand the biases that impact their target population. For example, financial inclusion schemes need to understand the biases that exist around female financial literacy.</li>
<li>Choice architects need to understand that the nudge policies make assumptions about the social preferences. A baseline understanding of local preferences at the local level is easier to obtain and targeting populations at the local level is easier. For instance, public health nudges at the local level are easier to identify based on local populations and their regular health goals.</li>
